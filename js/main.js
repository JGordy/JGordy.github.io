...
createIconsHTML = (icons) => {
    let iconsHTML = '';
    icons.forEach(icon => {
        iconsHTML += `<i class="material-icons">${icon}</i>`;
    })
    return iconsHTML;
}
...
createProjectHTML = (project) => {
    return `
        <div class="image-container ${project.mobile ? " mobile" : ''}">
                    ...
                    <div class="text">
                        <div class="views">
                            ...
                            <div class="view_icons">
                                ${createIconsHTML(project.icons)}
                            </div>
                        </div>
                        <div class="project_skills">
                            <div class="skills_list">
                                ${createSkillsHTML(project.skills)}
                            </div>
                        </div>
                    </div>
                </div>
